...
def test_django_guardian_install_and_remove(temp_dir):
    ...
    user_model_file = temp_dir / "users" / "models.py"
    ...
    settings_file = temp_dir / "settings" / "packages" / "django_guardian.py"
    ...
    assert PixiRunner().has_dependency("django-guardian"), (
    ...
    assert not PixiRunner().has_dependency("django-guardian"), (

...
def test_django_htmx_install_and_remove(temp_dir):
    ...
    settings_file = temp_dir / "settings" / "packages" / "django_htmx.py"
...
def test_django_htmx_import_from_new_path():
    """

...
def test_django_extensions_install_and_remove(temp_dir):
    ...
    settings_file = temp_dir / "settings" / "packages" / "django_extensions.py"
    ...
    assert PixiRunner().has_dependency("django-extensions"), (
    ...
    assert not PixiRunner().has_dependency("django-extensions"), (

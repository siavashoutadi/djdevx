...
def test_django_import_export_install_and_remove(temp_dir):
    ...
    settings_file = backend_dir / "settings" / "packages" / "django_import_export.py"
    ...
    assert DjangoProjectManager().has_dependency("django-import-export"), (
    ...
    assert not DjangoProjectManager().has_dependency("django-import-export"), (

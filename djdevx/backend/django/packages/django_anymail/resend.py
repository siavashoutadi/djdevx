...
def install(
    ...
    print_console.step("Installing django-anymail with Resend backend ...")
    ...
    print_console.success(
        "django-anymail with Resend backend is installed successfully."
    )
...
def remove():
    ...
    print_console.success("django-anymail Resend backend is removed successfully.")

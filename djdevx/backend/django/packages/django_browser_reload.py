...
def install():
    ...
    print_console.step("Installing django-browser-reload package ...")
    ...
    print_console.success("django-browser-reload is installed successfully.")
...
def remove():
    ...
    """
    print_console.step("Removing django-browser-reload package ...")
    ...
    print_console.success("django-browser-reload is removed successfully.")

...
def install():
    ...
    print_console.step("Installing django-auditlog package ...")
    ...
    print_console.success("django-auditlog is installed successfully.")
...
def remove():
    ...
    """
    print_console.step("Removing django-auditlog package ...")
    ...
    print_console.success("django-auditlog is removed successfully.")

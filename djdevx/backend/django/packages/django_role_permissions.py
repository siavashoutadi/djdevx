...
def install():
    ...
    print_console.step("Installing django-role-permissions package ...")
    uv_runner = UvRunner()
    ...
    print_console.success("django-role-permissions is installed successfully.")
...
def remove():
    ...
    """
    print_console.step("Removing django-role-permissions package ...")
    ...
    print_console.success("django-role-permissions is removed successfully.")

...
def install():
    ...
    print_console.step("Installing django-oauth-toolkit package ...")
    uv_runner = UvRunner()
    ...
    print_console.success("django-oauth-toolkit is installed successfully.")
...
def remove():
    ...
    """
    print_console.step("Removing django-oauth-toolkit package ...")
    ...
    print_console.success("django-oauth-toolkit is removed successfully.")
